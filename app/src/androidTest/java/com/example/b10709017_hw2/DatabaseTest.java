...
public class DatabaseTest {
    ...
    public void create_database_test() throws Exception{
        ...
        assertEquals("Error: Your database was created without the expected tables.",
                Contract.WaitlistEntry.TABLE_NAME, tableNameCursor.getString(0));
    ...
    public void insert_single_record_test() throws Exception{
        ...
        testValues.put(Contract.WaitlistEntry.COLUMN_GUEST_NAME, "test name");
        testValues.put(Contract.WaitlistEntry.COLUMN_PARTY_SIZE, 99);
    ...
    public void autoincrement_test() throws Exception{
        ...
        ContentValues testValues = new ContentValues();
        testValues.put(Contract.WaitlistEntry.COLUMN_GUEST_NAME, "Joe");
        testValues.put(Contract.WaitlistEntry.COLUMN_PARTY_SIZE, 40);
